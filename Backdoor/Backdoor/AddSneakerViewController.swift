...
class AddSneakerViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate,
    UINavigationControllerDelegate
{
    ...
    {
        self.selectImage()
        self.newSneaker.photo = sneakerImageView.image
    }
    ...
    {
        performSegue(withIdentifier: "unwindFromAddSneaker", sender: nil)
    }
    ...
    func textFieldDidEndEditing(_ textField: UITextField)
    {
        ...
        self.newSneaker.type = "manualAdd"
